package com.elmarangao.trackblaze.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.elmarangao.trackblaze.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.elmarangao.trackblaze.repository.UserRepository.USERS_BY_EMAIL_CACHE);
